...
// Define type-specific props interfaces
...
export interface TextMaskSectionProps {
  forceAnimation?: boolean;
}

export interface CardsParallaxSectionProps {
  cards: Array<{
    title: string;
    description: string;
    src: string;
